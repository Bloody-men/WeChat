          ...
          ul.slideDown('400', function() {
            $(this).find("li").bind("click",function(){
              ...
              var data = $(this).attr("data");
                $("#player_list").html('<a href="player.html"><ul class="hdk-Player"><div class="hdk-order"><p>9</p></div><div class="hdk-chart"><img src="img/222.jpg"></div><h5>张三</h5><span>票</span><p>12345</p></ul></a><a href="player.html">  <ul class="hdk-Player"><div class="hdk-order"><p>10</p></div><div class="hdk-chart"><img src="img/222.jpg"></div><h5>张三</h5><span>票</span><p>12345</p></ul></a>');
            })
          });
        }else{
...
//----money-----
  ...
  //----互动酷协议---
        $('#button,.hdk-vote').click(function(){
          $('.shadow,.qr').show();
        });
